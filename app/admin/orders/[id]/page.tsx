...
interface OrderDetail {
  ...
  items: Array<{ id: string; quantity: number; designSource: string; totalPrice: string; specifications: Record<string, string> | null; product?: { name: string; sku: string }; template?: { name: string } | null; artwork?: { originalFilename: string; contentType: string; fileSize: number; notes: string | null; sourceWidthPx: number | null; sourceHeightPx: number | null; originalUrl: string; previewUrl: string | null; dimensionWarning: string | null }; designUrl?: string; productionPreviewUrl?: string; productionUrl?: string; backProductionPreviewUrl?: string; backProductionUrl?: string }>
