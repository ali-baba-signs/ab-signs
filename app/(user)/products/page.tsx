...
interface Product { id: string; name: string; description: string | null; basePrice: string; featured: boolean; category: { slug: string; name: string } | null; images: Array<{ url: string; isPrimary: boolean }> }
