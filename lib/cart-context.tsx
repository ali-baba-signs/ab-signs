...
interface CartContextType { items: CartItem[]; total: number; ready: boolean; addItem: (item: Omit<CartItem, 'lineId'>) => void; removeItem: (lineId: string) => void; removePurchasedItems: (lines: PurchasedCartLine[]) => void; updateQuantity: (lineId: string, quantity: number) => void; clearCart: () => void }
