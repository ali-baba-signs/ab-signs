...
"[project]/components/live-chat/chat-widget.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatWidget() {
    ...
    const sessionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$6_$40$babel$2b$core$40$7$2e$2_40a7effce8bcad24669d45809ebe449e$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('');
        ...
        "ChatWidget.useEffect": ()=>{
            if (isOpen) {
                ...
                const timer = window.setInterval({
                    "ChatWidget.useEffect.timer": ()=>void loadMessages()
                }["ChatWidget.useEffect.timer"], 10000);
                return ({
                    "ChatWidget.useEffect": ()=>window.clearInterval(timer)
                })["ChatWidget.useEffect"];
            }
        }
    }["ChatWidget.useEffect"], [
...
_s(ChatWidget, "5QKws7wLxBDnM/df22RJc+6FekQ=");
_c = ChatWidget;
var _c;
...
//# sourceMappingURL=_00ac0-3._.js.map