...
"[project]/lib/editor/browser-preview.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function renderBrowserSide(canvasJson, productConfig) {
    ...
    const canvas = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$fabric$40$7$2e$4$2e$0$2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticCanvas"](element, {
        width,
        height,
...
"[project]/app/canvasfix01-test/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$fabric$40$7$2e$4$2e$0$2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/fabric@7.4.0/node_modules/fabric/dist/index.min.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$editor$2f$browser$2d$preview$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/editor/browser-preview.ts [app-client] (ecmascript)");
;
...
function CanvasFixVerificationPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$6_$40$babel$2b$core$40$7$2e$2_40a7effce8bcad24669d45809ebe449e$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CanvasFixVerificationPage.useEffect": ()=>{
            let disposed = false;
            const verify = {
                "CanvasFixVerificationPage.useEffect.verify": async ()=>{
                    const canvas = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$fabric$40$7$2e$4$2e$0$2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Canvas"](document.createElement('canvas'), {
                        width: 400,
                        height: 200,
                        backgroundColor: '#ffffff'
                    });
                    try {
                        const image = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$fabric$40$7$2e$4$2e$0$2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FabricImage"].fromURL('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=');
                        image.set({
                            left: 55,
                            top: 40,
                            angle: 27,
                        ...
                        canvas.add(image, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$fabric$40$7$2e$4$2e$0$2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textbox"]('Canvas preview text', {
                            left: 175,
                            top: 85,
                            width: 180,
                            fontSize: 24,
            ...
            }["CanvasFixVerificationPage.useEffect.verify"];
            void verify().catch({
                "CanvasFixVerificationPage.useEffect": (error)=>{
...
_s(CanvasFixVerificationPage, "5RhHUl8SmQ/1XGmXDZYMDejxPh8=");
_c = CanvasFixVerificationPage;
var _c;
__turbopack_context__.k.register(_c, "CanvasFixVerificationPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0dmqu1l._.js.map